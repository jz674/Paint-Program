...
class PaintGUI extends JFrame implements ActionListener, ChangeListener {
   ...
   /** Create the Tool Size slider --field toolSizeSlider*/
    ...
    private void updateSizeLabel() {
		...
		//lastImgWidth and lastImgHeight are fields in PaintGUI 
    ...
    private static ImageIcon getIcon(Color c, int size) {
		...
		//Object g2d has the functionality to do the drawing
		Graphics2D g2d= (Graphics2D) img.getGraphics();
		// set the drawing color and fill the complete image with that color
		g2d.setColor(c);
		g2d.fillRect(0, 0, img.getWidth(), img.getHeight());
		iCon.setImage(img);
		//return the ImageIcon that contains the image after the BufferedImage has been set
		return iCon;
    }
    ...
    @Override public void actionPerformed(ActionEvent e) {
       ...
       if (s == colorPicker) {
        ...
        if (s == foreColorButton) {
            ...
            //does this handle closing out the window?
